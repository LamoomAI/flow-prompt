...
if __name__ == "__main__":
    ...
    prompt.add('{messages}', is_multiple=True, in_one_message=True, label='messages')
    try:
        fp.call(prompt.id, context, gpt4_behaviour, stream_function=stream_function, check_connection=stream_check_connection, 
            params={"stream": True}, stream_params={"validate": True})
