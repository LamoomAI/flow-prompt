...
def test_flow_prompt(mock_azure_openai, flow_prompt: FlowPrompt, chat_completion_openai: ChatCompletion, azure_gpt_4_behaviour: AIModelsBehaviour, hello_world_prompt: PipePrompt):

    mock_openai_instance = mock_azure_openai.return_value
