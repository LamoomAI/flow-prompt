...
CHECK_LEFT_BUDGET = os.environ.get("LAMOOM_CHECK_LEFT_BUDGET", False)
...
LAMOOM_TOOL_CALL_RESULT_LEN_TO_SUMMARIZE = os.environ.get("LAMOOM_TOOL_CALL_RESULT_LEN_TO_SUMMARIZE", 1_000)
